...
lang_solr={'nl':'netherlands','de':'german','pl':'polish','cz':'czech','ru':'russian','ch':'chinese','gr':'greek','br':'brasilian','fr':'french','en':'english'}
...
#                conn.set_charset_collation('utf8', 'utf8')
    ...
    def save_corpus_to_fileSOLRformat(self,data,filename,lang_en,index=True):
        ...
        filen = './tobeindexed/'+ lang_solr2[lang_en] + "." + fn + "." + now + '.xml'
